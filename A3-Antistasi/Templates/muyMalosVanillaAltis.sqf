...
gruposCSATmid = [["O_soldier_TL_F","O_soldier_AR_F","O_soldier_GL_F","O_soldier_LAT_F"],gruposCSATAA,gruposCSATAT,["O_recon_TL_F","O_recon_JTAC_F","O_Pathfinder_F","O_recon_medic_F"]];
